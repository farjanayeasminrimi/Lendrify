      ...
      <footer className=" text-base-300 bg-[#2F3A3D] pt-10 pb-3 px-4 md:px-10">
        <div className="  text-base-300 flex  flex-col gap-6 md:gap-10  md:flex-row justify-between items-center ">
          <aside>
            ...
            <p className="text-[.9rem] text-[#A8B0B2]">
              Lendrify is a modern platform designed to simplify the way you discover and borrow
          ...
          <div className="footer flex flex-wrap md:flex-nowrap justify-between gap-4">
            <nav>
              ...
              <Link href={"/allbooks"} className="link link-hover">
                All Books
              </Link>
              <Link href={"/myprofile"} className="link link-hover">
                Profile
              </Link>
            ...
            <nav>
              ...
              <h1 className="text-md">+8801102020302</h1>
              <span className="text-[#A8B0B2]">Monday – Friday: 9:00-20:00 </span>
              <span className="text-[#A8B0B2]">Saturday: 11:00 – 15:00</span>
        ...
        <div className="">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between">
            <p className="text-xs text-[#A8B0B2]">© 2026 Lendrify. All rights reserved.</p>
            <div className="flex justify-between gap-6 description">
              <a className="text-xs text-[#A8B0B2]" href="#">
                Privacy Policy{" "}
              </a>
              <a className="text-xs text-[#A8B0B2]" href="#">
                Terms of Service
